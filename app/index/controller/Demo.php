...
class Demo
{
    ...
    public function getWxAccessToken(){
        $wx=new \wx\JSSDK("wx0c8b05496023af13","ad56f98ddf34a30134fcf460b4a1bcdd");
        echo $wx->getAccessToken("wx0c8b05496023af13");
    }
    //文件下载
    ...
    public function fy(){
        ...
        // 查询状态为1的用户数据 并且每页显示10条数据
            ...
            // $pageSize = 2;
            // $page = 2;
            $list = Db::name('ykb_article_enclosure')->where($map)->paginate(array('list_rows'=>$pageSize,'page'=>$page))
            ->toArray();
            // 把分页数据赋值给模板变量list
